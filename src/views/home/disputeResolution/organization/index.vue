<template>
  <div class="page">
      ...
      <div>
        <div v-for="(item, index) in subArr" :key="index" class="content">
          <div>
            ...
            <div class="serial-number"><span v-if="index+1 <10">0</span> {{ index +1 }}</div>
          </div>

          <div class="avatar">
            <img :src="item.picture" width="100px" height="100px" alt="头像">
          </div>
          <div class="subject">
            <div class="title">
              {{ item.name }}
              <span v-for="(type, key) in item.resodistype" :key="key + '-only'" style="margin-left: 5px">
            ...
            <div style="position:relative">
              ...
              <div style="display: inline;float: left;">
                ...
                <div style="position:relative">
                  <div v-show="item.affiliationLog" style="position:absolute;z-index:1;">
                    <AffiliatedUnit />
                  </div>

                  <div class="data">
                    <div class="type">
                      <div class="name">解纷员</div>
                      <div class="value">{{ item.disResolu }}人</div>
                    </div>
                    <div class="type">
              ...
              <div style="display: inline;float: right;">
                <div class="button">
                  <div style="margin-bottom:10px" class="findDisputes" @click="organizationDetailsLog">组织详情</div>
    ...
    <DisputeSolverLog ref="organizationLog" />
  </div>
</template>
...
import DisputeSolverLog from './components/disputeSolverLog.vue'
export default {
  components: {
    'a-icon': Icon,
    // 'a-button': Button,
  ...
  data() {
    return {
      ...
      // affiliationStr: affiliation.substring(0, 5),
      subArr: [
        {
          id: '1',
  ...
  methods: {
    // 单位详情
    organizationDetailsLog() {
      this.$refs.organizationLog.show()
    },
    // 查看更多
    showLog(event) {
