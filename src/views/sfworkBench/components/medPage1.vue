<template>
  <div>
    <Row>
      ...
      <Col :span="12">
        <Row class="left-container" style="height:500px">
          <div class="title">平均化解周期数</div>
          <Col span="11">
            <Row style="display:flex;height:250px">
              <DateLineChart ref="DateLineInit" style="margin-left:20px" />
              <Divider type="vertical" style="height:180px;margin-top:40px" />
            </Row>
            <Divider style="margin-top:-20px" />
            <Row class="header">
              <div class="container" style="margin-top:40px">
                <div class="content">
                  <div class="title1">{{ Ratelist[0].title }} </div>
                  <div class="title1">{{ Ratelist[0].value }}</div>
                </div>
              </div>
            </Row>
          </Col>
          <Col span="11">
            <Row style="margin-right:20px;height:250px;padding-top:50px">
              <div class="container" style="margin-top:20px">
                <div class="content">
                  <div class="title1">{{ Ratelist[1].title }} </div>
                  <div class="title1">{{ Ratelist[1].value }}</div>
                </div>
              </div>
              <Divider type="vertical" style="margin-left:-8px;height:180px;margin-top:85px" />
            ...
            <Row style="height:250px;">
              <div class="container" style="margin-top:40px">
                <div class="content">
                  <div class="title1">{{ Ratelist[2].title }} </div>
                  <div class="title1">{{ Ratelist[2].value }}</div>
                </div>
              </div>
            </Row>
          </Col>
...
export default {
  components: {
    Row, Col, LineChart, CollapseChart, DataBlock, MedRank, PieChart, DateLineChart, Divider
  },
  props: {
    timeParams: {
      type: Object,
